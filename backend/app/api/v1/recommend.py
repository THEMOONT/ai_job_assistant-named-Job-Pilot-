        ...
        if r.status_code == 200:
            ...
            for x in data:
                ...
                jobs.append({
                    ...
                    "apply_link": x.get("job_apply_link")
                })
...
# ADZUNA — NEW
# ---------------------------------------------------
async def fetch_adzuna(client, keyword, country_code):
        ...
        if r.status_code == 200:
            ...
            for x in data:
                ...
                jobs.append({
                    ...
                    "location": x.get("location", {}).get("display_name"),
                    "country": country_code.upper(),
                    "description": x.get("description"),
                    "apply_link": x.get("redirect_url")
                })
...
# ---------------------------------------------------
# ARBEITNOW — NEW (good for remote + international)
# ---------------------------------------------------
async def fetch_arbeitnow(client, keyword):
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=8) as client:
            ...
            res = await asyncio.gather(
                ...
                fetch_adzuna(client, keyword, country_code),
                fetch_arbeitnow(client, keyword),
        ...
        results.append({
            ...
            "country": country,
            "apply_link": "https://www.naukri.com/" + slug + "-jobs",
            "match_score": 85
        })
        ...
        results.append({
            ...
            "location": city or country,
            "country": country,
            "apply_link": "https://www.linkedin.com/jobs/search/?keywords=" + quote_plus(keyword),
            "match_score": 80
        })
        ...
        results.append({
            ...
            "location": city or country,
            "country": country,
            "apply_link": "https://www.indeed.com/jobs?q=" + quote_plus(role) + "&l=" + quote_plus(city or country),
            "match_score": 78
        })
        ...
        results.append({
            ...
            "location": city or country,
            "country": country,
            "apply_link": "https://www.glassdoor.com/Job/jobs.htm?sc.keyword=" + quote_plus(role),
            "match_score": 75
        })

        # Instahyre — NEW (India focused)
        results.append({
            "source": "Instahyre",
            "title": role,
            "company": "Search Jobs",
            "location": city or country,
            "country": country,
            "apply_link": "https://www.instahyre.com/search-jobs/?designation=" + quote_plus(role),
            "match_score": 72
        })
